class script(object):
    START_TXT = """𝙷𝙴𝙻𝙾 {},
𝙼𝚢 𝚗𝚊𝚖𝚎 , <a href='https://t.me/𝙽𝚒𝚜𝚌𝚑𝚊𝚢𝚈𝚍𝚟>𝙼𝚘𝚟𝚒𝚎𝚂𝚎𝚊𝚛𝚌𝚑𝙱𝚘𝚝</a>, 𝙸𝚝'𝚜 𝚟𝚎𝚛𝚢 𝚎𝚊𝚜𝚢 𝚓𝚞𝚜𝚝 𝚊𝚍𝚍 𝚖𝚎 𝚝𝚘 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙 𝚊𝚗𝚍 𝚖𝚊𝚔𝚎 𝚖𝚎 𝚊𝚍𝚖𝚒𝚗, 𝚃𝚑𝚊𝚝𝚜 𝚊𝚕𝚕 𝙸'𝚕𝚕 𝚙𝚛𝚘𝚟𝚒𝚍𝚎 『M』『o』『v』『i』『e』 𝚝𝚑𝚎𝚛𝚎 🤓
"""
    HELP_TXT = """𝙷𝙴𝚈 {}
𝘏𝘦𝘳𝘦 𝘐𝘴 𝘛𝘩𝘦 𝘏𝘦𝘭𝘱 𝘍𝘰𝘳 𝘔𝘺 𝘊𝘰𝘮𝘮𝘢𝘯𝘥𝘴."""
    ABOUT_TXT = """
𝗧𝗛𝗜𝗦 『D』『e』『v』『e』『l』『o』『p』『e』『r』'『s』 𝗔𝗕𝗢𝗨𝗧 𝗠𝗦𝗚
✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵
╔════❰ ꪖ᥇ꪮꪊ𝓽 ꪑ𝘴ᧁ ❱═❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣ 
║┣⪼ 𝙈𝙔 𝙉𝘼𝙈𝙀 - <a href="https://t.me/Proffeser_Z_bot"> 『N』『i』『s』『c』『h』『a』『y』 </a>
║┣⪼ Ⓓ︎Ⓔ︎Ⓥ︎1 - <a href="https://t.me/pro_editor_tg"> 𝑵ⅈ𝓼ｃһɑ𝑦  </a>
║┣⪼ Ⓓ︎Ⓔ︎Ⓥ︎2 - <a href="https://t.me/Proffeser_Z_bot">  </a>
║┣⪼ 𝓛𝓲𝓫𝓻𝓪𝓻𝓻𝔂 - 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
║┣⪼ 𝓛𝓪𝓷𝓰𝓾𝓪𝓰𝓮 - 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
║┣⪼ 𝓓𝓪𝓽𝓪 𝓑𝓪𝓼𝓮 - 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
║┣⪼ 𝓑𝓸𝓽 𝓼𝓮𝓻𝓿𝓮𝓻 -  𝙷𝙴𝚁𝙾𝙺𝚄
...
║╰━━━━━━━━━━━━━━━➣ ╚══════════════════❍⊱❁۪۪"""
    SOURCE_TXT = """<b>NOTE:</b>
- 𝑰 𝒂𝒎  𝖓օ𝘵 𝒂 𝒐𝒑𝒆𝒏 𝒔𝒐𝒖𝒓𝒄𝒆 𝒑𝒓𝒐𝒋𝒆𝒄𝒕. 
- V2 IS CLOSED SOURCE 😉
- ՏOᑌᖇᑕᗴ ᑕOᗪᗴ- Ｉｓ ｎｏｔ Ａｖａｉｌａｂｌｅ ｆｏｒ ｙｏｕ

𝗠𝗔𝗦𝗧𝗘𝗥:
<a href="@NischayYdv"> 『D』『e』『v』『s』♡｡^‿^｡ </a>"""
...
<b>Total ᴜsᴇʀs:</b> <code>{}</code>
<b>Total Chats:</b> <code>{}</code>
<b>Used sᴛᴏʀᴀᴇ:</b> <code>{}</code> MiB
<b>Free Storage:</b> <code>{}</code> MiB"""

    FORCESUB_TXT = """**♦️ READ THIS INSTRUCTION ♦️**

__🗣 In Order To Get The 『M』『o』『v』『i』『e』 Requested By You in Our Groups, You Will Have To Join Our Official Channel First. After That, Try Accessing That Music Again From Our Group. I'll Send You That 『M』『o』『v』『i』『e』 Privately 🙈__

**👇 JOIN THIS 『C』『h』『a』『n』『n』『e』『l』 & ᵀᴿᵞ ᴬᴳᴬᴵᴺ 👇**"""
