...
async def index_files(bot, query):
    ...
    await query.answer('『P』『r』『o』『c』『e』『s』『s』『i』『n』『g』♥︎...⏳', show_alert=True)
    ...
    await msg.edit(
        ...
        reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('『C』『a』『n』『c』『e』『l』', callback_data='index_cancel')]]
        )
    )
    try:
        chat = int(chat)
...
async def index_files_to_db(lst_msg_id, chat, msg, bot):
    ...
    async with lock:
        try:
            ...
            await msg.edit(f'【T】【o】【t】【a】【l】 <code>{total_files}</code> 𝘚ɑv𝖊𝒹.『i』『n』.『M』『y』 『H』『e』『a』『r』『t』!')
